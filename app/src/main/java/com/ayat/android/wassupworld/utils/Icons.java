package com.ayat.android.wassupworld.utils;
...
public class Icons {
    ...
    public static int getCategoryIcon(String title) {
        int id=0;
            ...
            switch (title) {
                case "General":
                    ...
                    break;
                case "Business":
                    id = R.drawable.ic_business_center_black_24dp;
                    break;
                case "Entertainment":
                    id = R.drawable.movie;
                    break;
    ...
    public static int getCategoryColor(String title) {
